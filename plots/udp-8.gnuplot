...
plot '../results/online-8-avg.csv' u 1:3 w lines smooth sbezier title "MARL" dt 1, \
     '../results/m-udp-natural-8' u 1:3 w lines smooth sbezier title "MARL++" ls 3 dt (18,2,2,2), \
     '../results/spf-udp-natural-8' u 1:3 w lines smooth sbezier title "SPF" ls 7 dt (6,2,2,2), \

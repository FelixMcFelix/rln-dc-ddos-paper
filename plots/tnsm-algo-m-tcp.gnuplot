...
set output "tnsm-algo-m-tcp.tex"
...
plot '../results/tnsm-tree-16-tcp-m-separate.avg.csv' u 1:3 w lines smooth sbezier title "Marl (Sarsa, Sep)" dt 1, \
     '../results/tnsm-algo-tree-16-tcp-m-separate.avg.csv' u 1:3 w lines smooth sbezier title "Marl (Q, Sep)" dt 1

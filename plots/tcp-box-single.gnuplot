...
plot '../results/online-2-avg-ng.csv' u (0.0):3:(1.0) ls 2 ps .1, \
     '../results/m-tcp-single-2' u (1.0):3:(1.0) ls 2 ps .1, \
     '../results/spf-tcp-single-2' u (2.0):3:(1.0) ls 2 ps .1, \
     '../results/online-4-avg-ng.csv' u (4.0):3:(1.0) ls 3 ps .1, \
     '../results/m-tcp-single-4' u (5.0):3:(1.0) ls 3 ps .1, \
     '../results/spf-tcp-single-4' u (6.0):3:(1.0) ls 3 ps .1, \
     '../results/online-8-avg-ng.csv' u (8.0):3:(1.0) ls 5 ps .1, \
     '../results/m-tcp-single-8' u (9.0):3:(1.0) ls 5 ps .1, \
     '../results/spf-tcp-single-8' u (10.0):3:(1.0) ls 5 ps .1, \
     '../results/online-16-avg-ng.csv' u (12.0):3:(1.0) ls 6 ps .1, \
     '../results/m-tcp-single-16' u (13.0):3:(1.0) ls 6 ps .1, \
     '../results/spf-tcp-single-16' u (14.0):3:(1.0) ls 6 ps .1, \

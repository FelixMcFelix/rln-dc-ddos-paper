...
plot '../results/m-tcp-uncap-2' u 1:3 w lines smooth sbezier title "$n=2$" dt 1, \
     '../results/m-tcp-uncap-4' u 1:3 w lines smooth sbezier title "$n=4$" dt (18,2,2,2), \
     '../results/m-tcp-uncap-8' u 1:3 w lines smooth sbezier title "$n=8$" ls 4  dt (6,2,2,2), \
     '../results/m-tcp-uncap-16' u 1:3 w lines smooth sbezier title "$n=16$" ls 5 dt (18,2)#, \

...
plot '../results/baseline-2-avg.csv' u (0.0):3:(1.0) ls 1, \
     ...
     '../results/ft-cap-f0-avg.csv' u (3.0):3:(1.0) ls 3, \
     '../results/ft-cap-f2-avg.csv' u (4.5):3:(1.0) ls 4, \
     '../results/ft-cap-f3-avg.csv' u (6.0):3:(1.0) ls 5, \
     '../results/ft-cap-f4-avg.csv' u (7.5):3:(1.0) ls 6, \
     '../results/ft-cap-f5-avg.csv' u (9.0):3:(1.0) ls 7, \
     '../results/ft-cap-f6-avg.csv' u (10.5):3:(1.0) ls 8, \
     '../results/ft-cap-f7-avg.csv' u (12.0):3:(1.0) ls 2, \
     '../results/ft-cap-f8-avg.csv' u (13.5):3:(1.0) ls 3, \
     '../results/ft-cap-f9-avg.csv' u (15.0):3:(1.0) ls 4, \
     '../results/ft-cap-f10-avg.csv' u (16.5):3:(1.0) ls 5, \
     '../results/ft-cap-f11-avg.csv' u (18.0):3:(1.0) ls 6, \
     '../results/ft-cap-f12-avg.csv' u (19.5):3:(1.0) ls 7, \
     '../results/ft-cap-f13-avg.csv' u (21.0):3:(1.0) ls 8

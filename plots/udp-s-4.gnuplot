...
plot '../results/online-4-avg.csv' u 1:3 w lines smooth sbezier title "MARL" dt 1, \
     '../results/spf-udp-natural-4' u 1:3 w lines smooth sbezier title "SPF" dt (18,2,2,2), \
     '../results/spf-udp-banded-4' u 1:3 w lines smooth sbezier title "SPF (Banded)" ls 4  dt (6,2,2,2), \
     '../results/spf-udp-single-4' u 1:3 w lines smooth sbezier title "SPF (Single Agent)" ls 5 dt (18,2), \
     '../results/spf-udp-uncap-4' u 1:3 w lines smooth sbezier title "SPF (Uncapped)" ls 6 dt (6,2), \

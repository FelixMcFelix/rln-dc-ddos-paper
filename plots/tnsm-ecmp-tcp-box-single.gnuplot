...
set output "tnsm-ecmp-tcp-box-single.tex"
...
plot '../results/tnsm-ecmp-2-tcp-m-separate.avg.csv' u (0.0):3:(1.0) ls 1 ps .1, \
     '../results/tnsm-ecmp-2-tcp-mpp-single.avg.csv' u (1.0):3:(1.0) ls 1 ps .1, \
     '../results/tnsm-ecmp-2-tcp-spf-single.avg.csv' u (2.0):3:(1.0) ls 1 ps .1, \
     '../results/tnsm-ecmp-4-tcp-m-separate.avg.csv' u (4.0):3:(1.0) ls 3 ps .1, \
     '../results/tnsm-ecmp-4-tcp-mpp-single.avg.csv' u (5.0):3:(1.0) ls 3 ps .1, \
     '../results/tnsm-ecmp-4-tcp-spf-single.avg.csv' u (6.0):3:(1.0) ls 3 ps .1, \
     '../results/tnsm-ecmp-8-tcp-m-separate.avg.csv' u (8.0):3:(1.0) ls 5 ps .1, \
     '../results/tnsm-ecmp-8-tcp-mpp-single.avg.csv' u (9.0):3:(1.0) ls 5 ps .1, \
     '../results/tnsm-ecmp-8-tcp-spf-single.avg.csv' u (10.0):3:(1.0) ls 5 ps .1, \
     '../results/tnsm-ecmp-16-tcp-m-separate.avg.csv' u (12.0):3:(1.0) ls 7 ps .1, \
     '../results/tnsm-ecmp-16-tcp-mpp-single.avg.csv' u (13.0):3:(1.0) ls 7 ps .1, \
     '../results/tnsm-ecmp-16-tcp-spf-single.avg.csv' u (14.0):3:(1.0) ls 7 ps .1, \

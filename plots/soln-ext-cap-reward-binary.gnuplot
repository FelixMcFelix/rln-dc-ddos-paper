...
set output "soln-ext-cap-reward-binary.tex"
...
plot '../results/soln-ext-cap-2-avg.csv' u 1:2 w lines smooth sbezier title "$n=2$", \
     '../results/soln-ext-cap-4-avg.csv' u 1:2 w lines smooth sbezier title "$n=4$", \
     '../results/soln-ext-cap-8-avg.csv' u 1:2 w lines smooth sbezier title "$n=8$"#, \

...
set output "ftprep-tcp-reward.tex"
...
plot '../results/baseline-2-uncap-avg-ng.csv' u 1:2 w lines smooth sbezier title "baseline", \
     ...
     '../results/ft-tcp-f2-avg.csv' u 1:2 w lines smooth sbezier title "f2", \
     '../results/ft-tcp-f3-avg.csv' u 1:2 w lines smooth sbezier title "f3"

...
plot '../results/online-2-avg-ng.csv' u (0.0):3:(1.0) ls 2 ps .1, \
     '../results/m-tcp-natural-2.avg.csv' u (1.0):3:(1.0) ls 2 ps .1, \
     '../results/spf-tcp-natural-2.avg.csv' u (2.0):3:(1.0) ls 2 ps .1, \
     '../results/online-4-avg-ng.csv' u (4.0):3:(1.0) ls 3 ps .1, \
     '../results/m-tcp-natural-4.avg.csv' u (5.0):3:(1.0) ls 3 ps .1, \
     '../results/spf-tcp-natural-4.avg.csv' u (6.0):3:(1.0) ls 3 ps .1, \
     '../results/online-8-avg-ng.csv' u (8.0):3:(1.0) ls 5 ps .1, \
     '../results/m-tcp-natural-8.avg.csv' u (9.0):3:(1.0) ls 5 ps .1, \
     '../results/spf-tcp-natural-8.avg.csv' u (10.0):3:(1.0) ls 5 ps .1, \
     '../results/online-16-avg-ng.csv' u (12.0):3:(1.0) ls 6 ps .1, \
     '../results/m-tcp-natural-16.avg.csv' u (13.0):3:(1.0) ls 6 ps .1, \
     '../results/spf-tcp-natural-16.avg.csv' u (14.0):3:(1.0) ls 6 ps .1, \

...
plot '../results/baseline-2-avg-ng.csv' u 1:3 w lines smooth sbezier title "Baseline" dt 1, \
     '../results/ft-tcp-cap-f4-avg.csv' u 1:3 w lines smooth sbezier title "Correspondence Ratio" ls 2 dt (18,2,2,2), \
     '../results/ft-tcp-cap-f5-avg.csv' u 1:3 w lines smooth sbezier title "Mean IAT" ls 4 dt (6,2,2,2), \
     '../results/ft-tcp-cap-f6-avg.csv' u 1:3 w lines smooth sbezier title "$\\Delta{}$ In Rate" ls 6 dt (18,2), \
     '../results/ft-tcp-cap-f7-avg.csv' u 1:3 w lines smooth sbezier title "$\\Delta{}$ Out Rate" ls 8 dt (6,2)

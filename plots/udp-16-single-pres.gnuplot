...
set output "udp-16-single-pres.tex"
...
plot '../results/online-16-avg.csv' u 1:3 w lines smooth sbezier title "Marl" dt 1, \
     '../results/m-udp-natural-16' u 1:3 w lines smooth sbezier title "Marl++" ls 3 dt (18,2,2,2), \
     '../results/spf-udp-natural-16' u 1:3 w lines smooth sbezier title "SPF" ls 5 dt (6,2,2,2), \
     '../results/m-udp-single-16' u 1:3 w lines smooth sbezier title "Marl++ (Single)" ls 6 dt (18,2), \
     '../results/spf-udp-single-16' u 1:3 w lines smooth sbezier title "SPF (Single)" ls 7 dt (6,2), \
     '../results/udp-combo-channel-16-avg.csv' u 1:3 w lines smooth sbezier title "Marl++ (Pretrain)" ls 8 dt (18,2), \
     '../results/udp-spf-combo-channel-16-avg.csv' u 1:3 w lines smooth sbezier title "SPF (Pretrain)" ls 9 dt (6,2), \

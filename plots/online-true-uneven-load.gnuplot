...
set output "online-true-uneven-load.tex"
...
plot us(x) w dots title "Max capacity", \
     '../results/online-avg-uneven.csv' u 1:4 w lines smooth sbezier title "Lexicographic", \
     '../results/online-avg.csv' u 1:4 w lines smooth sbezier title "Uniform"

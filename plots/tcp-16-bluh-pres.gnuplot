...
set output "tcp-16-bluh-pres.tex"
...
plot '../results/online-16-avg-ng.csv' u 1:3 w lines smooth sbezier title "Marl" dt 1, \
     ...
     '../results/spf-tcp-natural-16' u 1:3 w lines smooth sbezier title "SPF" ls 4 dt (6,2,2,2), \
     '../results/m-tcp-single-16' u 1:3 w lines smooth sbezier title "Marl++ (Single)" ls 5 dt (18,2), \
     '../results/spf-tcp-single-16' u 1:3 w lines smooth sbezier title "SPF (Single)" ls 6 dt (6,2), \
     '../results/tcp-combo-channel-16-avg.csv' u 1:3 w lines smooth sbezier title "Marl++ (Pretrain)" ls 7 dt (18,2), \
     '../results/tcp-spf-combo-channel-16-avg.csv' u 1:3 w lines smooth sbezier title "SPF (Pretrain)" ls 8 dt (6,2), \

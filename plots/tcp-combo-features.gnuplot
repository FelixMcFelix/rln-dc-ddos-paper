...
set output "tcp-combo-features.tex"
...
plot '../results/tcp-combo-prep-f5-avg.csv' u 1:3 w lines smooth sbezier title "Mean IAT" dt 1, \
     '../results/tcp-combo-prep-f7-avg.csv' u 1:3 w lines smooth sbezier title "D In" dt (18,2,2,2), \
     '../results/tcp-combo-prep-f6-avg.csv' u 1:3 w lines smooth sbezier title "D Out" ls 4  dt (6,2,2,2), \

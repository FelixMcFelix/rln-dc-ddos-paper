...
plot '../results/online-2-avg-ng.csv' u 1:3 w lines smooth sbezier title "MARL" dt 1, \
     '../results/m-tcp-natural-2' u 1:3 w lines smooth sbezier title "MARL++" dt (18,2,2,2), \
     '../results/m-tcp-banded-2' u 1:3 w lines smooth sbezier title "MARL++ (Banded)" ls 4  dt (6,2,2,2), \

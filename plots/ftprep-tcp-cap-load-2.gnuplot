...
set output "ftprep-tcp-cap-load-2.tex"
...
plot '../results/baseline-2-avg-ng.csv' u 1:4 w lines smooth sbezier title "baseline", \
     '../results/ft-tcp-cap-f4-avg.csv' u 1:4 w lines smooth sbezier title "f4", \
     '../results/ft-tcp-cap-f5-avg.csv' u 1:4 w lines smooth sbezier title "f5", \
     '../results/ft-tcp-cap-f6-avg.csv' u 1:4 w lines smooth sbezier title "f6", \
     '../results/ft-tcp-cap-f7-avg.csv' u 1:4 w lines smooth sbezier title "f7"

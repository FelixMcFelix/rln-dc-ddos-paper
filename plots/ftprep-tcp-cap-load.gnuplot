...
set output "ftprep-tcp-cap-load.tex"
...
plot '../results/baseline-2-avg-ng.csv' u 1:4 w lines smooth sbezier title "baseline", \
     '../results/ft-tcp-cap-g-avg.csv' u 1:4 w lines smooth sbezier title "G", \
     '../results/ft-tcp-cap-f0-avg.csv' u 1:4 w lines smooth sbezier title "f0", \
     '../results/ft-tcp-cap-f1-avg.csv' u 1:4 w lines smooth sbezier title "f1", \
     '../results/ft-tcp-cap-f2-avg.csv' u 1:4 w lines smooth sbezier title "f2", \
     '../results/ft-tcp-cap-f3-avg.csv' u 1:4 w lines smooth sbezier title "f3"

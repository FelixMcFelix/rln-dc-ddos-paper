...
ft = __import__("tcp-spf-combo-channel-prep")
...
if __name__ == "__main__":
	...
	for (target_results, start_fresh, config_name, ep_len) in configs:
		...
		csv_dir = ft.results_dir + "tcp-spf-combo-channel-{}.csv".format(hosts_p)
		avg_csv_dir = ft.results_dir + "tcp-spf-combo-channel-{}-avg.csv".format(hosts_p)

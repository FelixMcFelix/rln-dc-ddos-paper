...
ft = __import__("feature-test-cap-prep")
...
if __name__ == "__main__":
	...
	for (target_results, start_fresh, config_name, ep_len) in configs:
		for i, (rs, gs, ls) in enumerate(target_results):
			csv_dir = ft.results_dir + "ft-cap-{}-f{}.csv".format(config_name, i)
			avg_csv_dir = ft.results_dir + "ft-cap-{}-f{}-avg.csv".format(config_name, i)

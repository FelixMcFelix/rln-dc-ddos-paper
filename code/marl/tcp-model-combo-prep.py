...
results_dir = "../../results/"
file_dir = results_dir + "tcp-combo-prep.pickle"
chosen_features = [
	5, # Mean IAT
	7, # Delta Out Rate
	6, # Delta In Rate
...
if __name__ == "__main__":
	...
	for ((rs, gs, ls), out_name) in zip(result_sets, out_names):
		csv_dir = results_dir + "tcp-combo-prep-{}.csv".format(out_name)
		avg_csv_dir = results_dir + "tcp-combo-prep-{}-avg.csv".format(out_name)

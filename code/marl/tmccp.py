...
host_ps = [2, 4, 8, 16]
results_dir = "../../results/"
file_dir = results_dir + "tmccp-{}.pickle"
in_progress_file_dir = results_dir + "tmccp-prg-{}.pickle"
chosen_features = [
	5, # Mean IAT
	7, # Delta Out Rate
	6, # Delta In Rate
...
if __name__ == "__main__":
	...
	for ((rs, gs, ls), out_name) in zip(result_sets, out_names):
		csv_dir = results_dir + "tmccp-{}-{}.csv".format(out_name, hosts_p)
		avg_csv_dir = results_dir + "tmccp-{}-{}-avg.csv".format(out_name, hosts_p)

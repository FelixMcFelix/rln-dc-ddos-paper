...
results_dir = "../../results/"
file_dir = results_dir + "bonus-ftprep-cap.pickle"
n_features = 8
n_new_features = 6
n_episodes = 10
...
if __name__ == "__main__":
	...
	for ((rs, gs, ls), out_name) in zip(result_sets, out_names):
		csv_dir = results_dir + "ft-cap-{}.csv".format(out_name)
		avg_csv_dir = results_dir + "ft-cap-{}-avg.csv".format(out_name)

...
\begin{figure}
	...
	\caption{
		Mean Marl action values for Mean IAT when $n=16$.
		The lightest cell in any row would ordinarily be the action most likely to be chosen: this isn't actually a policy because it's mean'd.
...
\Cref{fig:intern-16-tcp-iat} shows how we may visualise the portion of a policy for a single feature.

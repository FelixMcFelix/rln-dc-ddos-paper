...
\begin{figure}
	...
	\caption{
		Online performance for HTTP benign traffic in a single-destination network, multi-agent mode.
...
\begin{figure}
	...
	\caption{
		...
		At this level of host density, Guarded reaches higher peak performance sooner and is considerably more consistent throughout the episode.
		Guarded benefits greatly from information sharing, converging to protect around \SI{75}{\percent} of TCP traffic within \SI{100}{\second}.
		The Instant model converges to perform similarly to Marl.
...
?? I believe their assumptions may not extend to CBR traffic (e.g., UDP VoIP traffic), which we know makes up a sizeable proportion of network traffic. Also DASH traffic.

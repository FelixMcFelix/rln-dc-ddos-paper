...
Accordingly, application of machine learning-based techniques is difficult.
...
Our results show the existence of flow features with high predictive power for different traffic classes, when a basis for feedback-loop-like control.

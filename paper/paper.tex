...
%	\clearfield{month}
	...
	\ifentrytype{misc}{}{% Remove url except for misc and online.
		\ifentrytype{online}{}{
			\clearfield{url}
		}
	}
...
\newcommand\orcidicon[1]{
	\href{https://orcid.org/#1}{\mbox{\scalerel*{
...
%\colorlet{revisiontext}{uofgcobalt}
...
%	Kyle~A.~Simpson\thanks{This work was supported by the Engineering and Physical Sciences Research Council [grant number EP/M508056/1].},
	\protect Kyle~A.~Simpson\protect\orcidicon{0000-0001-8068-9909},
%	Kyle~A.~Simpson,
	Simon~Rogers\protect\orcidicon{0000-0003-3578-4477},
%	Simon~Rogers,
	Dimitrios~P.~Pezaros\protect\orcidicon{0000-0003-0939-378X},~\IEEEmembership{Senior~Member,~IEEE},\\
...
%	University of Glasgow, Glasgow, Scotland,\\
	\email{k.simpson.1@research.gla.ac.uk}, \email{Simon.Rogers@glasgow.ac.uk}, \email{Dimitrios.Pezaros@glasgow.ac.uk}
%Anonymous Giraffe,
%Anonymous Badger,
%Anonymous Ibex\\
...
\cbstart {\color{revisiontext}In the event that the path from an agent to its destination is shorter than 4 hops, we duplicate (in order of preference) the load measurement of a middle hop or the last hop.} \cbend
...
\cbstart {\color{revisiontext}Rather than having the network push the data to an agent, the agent requests this information about active flows periodically to isolate it from non-control-plane traffic and to eliminate the risk of resource exhaustion by excessive requests.} \cbend
...
\begin{figure}
	\centering
	\includegraphics[width=0.65\linewidth]{ftprep-cap-box}
	\vspace{-0.75cm}
	\caption{
...
\begin{figure}
	\centering
	\includegraphics[width=0.65\linewidth]{ftprep-tcp-cap-box}
	\vspace{-0.75cm}
	\caption{
...
\begin{figure}
	\centering
%	\vspace{-0.25cm}
	\includegraphics[width=0.65\linewidth]{ftprep-tcp-laf-cap-box}
	\vspace{-0.75cm}
	\caption{
...
Each host's download rate is limited to match the maximum bandwidth assigned to it, and requests several random files known to exist within a website, followed by any dependent resources for each (stylesheets, images, etc.) \cbstart {\color{revisiontext}as a browser \cbend might.}
...
\begin{table}
	...
	\resizebox{0.8\linewidth}{!}{
		\expandableinput tnsm-tree-avg-reward-spiffy.tex
	}
	\cbend
\vspace{-0.25cm}
\end{table}
\begin{table}
	...
	\cbstart
	\resizebox{0.8\linewidth}{!}{
		\expandableinput tnsm-ecmp-avg-reward-spiffy.tex
	}
	\cbend
\vspace{-0.5cm}
\end{table}
...
\begin{figure}
	\centering
	\cbstart
	\includegraphics[width=0.75\linewidth]{tnsm-udp-box-separate}
	\cbend
	\vspace{-0.3cm}
	\caption{
...
\cbstart {\color{revisiontext}Interestingly, SPIFFY is unable to effectively protect constant bitrate traffic.} \cbend
...
%	\vspace{-0.5cm}
	\centering
	\cbstart
	\includegraphics[width=0.75\linewidth]{tnsm-tcp-box-single}
	\cbend
	\vspace{-0.3cm}
	\caption{
...
\vspace{-0.1cm}
The authors would like to thank Colin Perkins, Mircea Iordache, Qianru Zhou, Charles Rutherford, Marco Cook and Cristian Urlea for their advice and technical assistance, and their anonymous reviewers.
...
This work has been supported in part by the UK Engineering and Physical Sciences Research Council [grants EP/N509668/1, EP/N033957/1 and EP/P004024/1] and European Cooperation in Science and Technology (COST) Action CA15127: RECODIS---Resilient communication and services.
\vspace{-0.55cm}

...
All internal routers are primed with knowledge of the shortest path to each internal host, while new inbound flows register the ``way back'' for each hop used to maintain consistency over traffic conditions.
...
\begin{itemize}
	\item \emph{long flow} testing has each host constantly request a large binary, such as a tarball of GCC8;
...
Our thanks go to Mircea Iordache, Qianru Zhou, and Richard Cziva for their comments and technical assistance.

...
?? What other choices did we make? Taking actions with (and updating) fewer tiles according to probability $\epsilon$. Updating all tiles' action value estimates separately to produce different update targets.

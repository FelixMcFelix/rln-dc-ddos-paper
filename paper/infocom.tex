...
\begin{figure}
	...
	\resizebox{\linewidth}{!}{\begin{tikzpicture}
		\node(remote){Remote};
		\node[below=4 of remote](linestart){};
%		\node[on grid, right=1 of linestart](lineend){};
		\path let \p1 = (linestart) in node (lineend) at (10,\y1){};
		\draw [dashed] (linestart) -- (lineend);
		\node[below of=linestart](local){Local};
	\end{tikzpicture}}
